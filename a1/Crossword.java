...
*	Assignment 1												*
*	Description: Program to search for solutions to crossword 	*
*   puzzles with sizes from 3x3 to 8x8 using either a sorted 	*
*	array-based dictionary, or a de la Briandais tree 			*
*																*
*	Command line format: java Crossword dictType testFile.txt   *
